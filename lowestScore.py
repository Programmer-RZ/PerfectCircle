...
pyautogui.moveTo(center_of_circle[0], center_of_circle[1]+start_radius)
pyautogui.mouseDown()
pyautogui.moveTo(center_of_circle[0], center_of_circle[1]+radius)

for i in range(int(360*vertices)):
